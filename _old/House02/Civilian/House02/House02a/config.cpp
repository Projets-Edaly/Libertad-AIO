class CfgPatches
{
	class Edaly_Structures_Assets_1_Civil_House02a
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	class House;
	class House_F: House{};
	class Edaly_Str_House02a_F: House_F
	{
		scope = 2;
		displayName = "Maison de Campagne 02a";
        author = "GeK";
		editorCategory = "EdCat_Edaly";
		editorSubcategory = "EdSubcat_Edaly_Structures";
		model = "Edaly_Structures_Assets_4\Civilian\House02\House02a\House02a.p3d";
		mapSize = 7;
		cost = 40000;
