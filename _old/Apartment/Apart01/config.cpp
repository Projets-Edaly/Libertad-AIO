class CfgPatches
{
	class Edaly_Structures_Assets_1_Civil_Apartment_01
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	class House;
	class House_F: House{};
	class Edaly_Str_Apartment_01_F: House_F
	{
		scope = 2;
		displayName = "Appartement 01";
        author = "GeK";
		editorCategory = "EdCat_Edaly_Structures";
		editorSubcategory = "EdSubcat_Edaly_Civil";
		model = "Edaly_Structures_Assets_1\Civilian\Apartment\Apart01\Apartment_01.p3d";
		mapSize = 7;
		cost = 40000;
