...
class RscDisplayMultiplayer : RscStandardDisplay {
	...
	class controlsbackground {
		...
		class MainBackground : RscPicture {
			...
			idc = 1081;
			text = "\Edaly_UI_Menu\data\main_title_02.jpg";
			x = -0.000141399 * safezoneW + safezoneX;
			y = -0.00379994 * safezoneH + safezoneY;
			w = 1.01063 * safezoneW;
			h = 1.012 * safezoneH;
		};
	...
	class controls {
		...
		class CA_Cancel : RscButtonMenuCancel {
			text = $STR_DISP_BACK;
			x = 1.00016 * safezoneW + safezoneX;
			y = 1.006 * safezoneH + safezoneY;
		...
		*/
		...
		class CA_ServerColumn : RscButtonTextOnly {
			idc = 112;
			sizeEx = (			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8) * GUI_GRID_H;			style = 0;
